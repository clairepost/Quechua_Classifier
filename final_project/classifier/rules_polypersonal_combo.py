...
def poly(text, tags):
    ...
    endings = [
        "manqui", "masha", "manchi", "chimasha", "shunqui", "shcanqui", "mushcä", "huangui", "huanguichic",
        "mashcanqui", "manquitsu", "mushga", "manga", "munki", "manki", 
        "huanqui", "huarca", "cuśhunqui", "chwanpis", "wanki", "wan", "wankichik",
        "wanku", "wankiku", "sunki", "ykichik", "sunkichik", "wanchej", "yki",
